...
namespace SpukaAp
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddScoped<IDataRepository2<TAdressen, AdresseDTO>, AdressenDataManager>();
            services.AddScoped<IDataRepository<TBeguenstigte, BeguenstigteDTO>, BeguenstigteDataManager>();
